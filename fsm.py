...
class TocMachine(GraphMachine):
    ...
    def is_going_to_choose(self, event):
        ...
        if ((self.state == "girlshorthair"or self.state == "girllonghair") and (text.lower() == "back")):
            return True
    ...
    def on_enter_choose(self, event):
        ...
        url = 'https://claireguentz.com/wp-content/uploads/2020/03/IMG_8730.jpg'
    ...
    def on_enter_girlshortimg1(self, event):
        url = 'https://content.latest-hairstyles.com/wp-content/uploads/fun-short-layered-hair-with-beachy-waves.jpg'
    ...
    def is_going_to_girlshortimg2(self, event):
        ...
        if text == '圖2':
            return True
        return False
    def on_enter_girlshortimg2(self, event):
    ...
    def is_going_to_girlshortimg3(self, event):
        ...
        if text == '圖3':
            return True
        return False
    def on_enter_girlshortimg3(self, event):
    ...
    def on_enter_girllonghair(self, event):
        title = '想知道的內容'
        text = '輸入『長髮髮型』可以查看髮型推薦。\n輸入『長髮介紹』或『長髮髮廊』會有文字說明。\n輸入『back』返回選單。'
        btn = [
            MessageTemplateAction(
                label = '長髮髮型',
                text ='長髮髮型'
    ...
    def on_enter_girllongimg1(self, event):
    ...
    def is_going_to_girllongimg2(self, event):
        ...
        if text == '圖2':
            return True
        return False
    def on_enter_girllongimg2(self, event):
    ...
    def is_going_to_girllongimg3(self, event):
        ...
        if text == '圖3':
            return True
        return False
    def on_enter_girllongimg3(self, event):
